...
contract StopOnRevertHandler is Test {
    ...
    function redeemCollateral(uint256 collateralSeed, uint256 amountCollateral) public {
        ...
        // we can't put 1 here, because maxCollateral might be 0 and this would cause the bound function to fail
        amountCollateral = bound(amountCollateral, 0, maxCollateral);
        //vm.prank(msg.sender);
        if (amountCollateral == 0) {
            //@note this would trigger a revert => so, we just abandon this test case and start a new fuzz run
            return;
        }
        vm.prank(msg.sender);
    ...
    // Aggregator //
    /////////////////////////////
    //there will be cases, where the price goes down a lot => our collateral will become almost worthless => this will break our invariant
