...
//@note inherit from StdInvariant
contract ContinueOnRevertInvariants is StdInvariant, Test {
    ...
    function setUp() external {
        ...
        //@note create the handler contract & set it as target => fuzzer calls all functions in Handler randomly
    ...
    //@note execute this invariant test => fuzzer randomly calls all public functions in the Handler => assert at the end of this func must pass
