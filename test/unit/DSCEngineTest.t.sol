...
contract DSCEngineTest is StdCheats, Test {
    ...
    function setUp() external {
        //@note deploy contracts=> we can also use our script & execute the run func
    ...
    function testRevertsIfTokenLengthDoesntMatchPriceFeeds() public {
        ...
        //@note test a revert with a specific custom error
    ...
    function testRevertsIfTransferFromFails() public {
        ...
        //@note we want to test the case where transferFrom fails => create a special MockERC20 token where transferFrom fails =>
        // we use this token as our collateral token (like ETH, BTC...) AND, also as our stablecoin
        ...
        //deposit collat will always fail, because transferFrom always fails in our mock token
    ...
    function testRevertsWithUnapprovedCollateral() public {
        ...
        vm.startPrank(user);
        //@note use encodeWithSelector, because we also have an arg
    ...
    //@note use a modifier to execute a certain functionality thats used in several tests => eg: depositCollat
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        //mint same amount as collat => breaks health factor
